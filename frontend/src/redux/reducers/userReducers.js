...
export const userRegisterReducer = (state = {}, action) => {
  ...
  case userConstants.USER_REGISTER_SUCCESS:
    return { isLoading: false, message: action.payload, isSuccess: true }
